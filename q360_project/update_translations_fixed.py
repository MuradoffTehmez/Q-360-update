...
def update_po_file(po_file_path):
    ...
    # Pattern: match msgid followed by an empty msgstr on a new line
    pattern = r'msgid "(.*?)"\nmsgstr ""'
    matches = re.findall(pattern, content)
    
    # Replace each entry with its English translation
    for msgid_text in matches:
        en_translation = translate_azerijani_to_english(msgid_text)
        old_entry = f'msgid "{msgid_text}"\nmsgstr ""'
        new_entry = f'msgid "{msgid_text}"\nmsgstr "{en_translation}"'
